  ...
  return (
    <section className="pt-20">
      <article className="flex flex-row justify-center items-center">
        <section className="lg:w-3/5 w-4/5 relative mx-auto flex flex-col text-center items-center justify-center sm:max-w-screen-sm md:max-w-screen-md">
        ...
        <section className="lg:w-2/5 w-1/5 flex items-center">
          <img
            src={ebookImg}
            alt="eBooks"
