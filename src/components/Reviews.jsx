...
const reviews = [
  {
    review: "A fantastic collection of books covering a wide range of subjects. The platform is easy to navigate and offers great reading experiences.",
    reviewerName: "John Doe",
    reviewerRole: "Teacher"
  },
  {
    review: "I found the content to be very enriching and informative. It's wonderful to have access to such valuable resources for free.",
    reviewerName: "Jane Smith",
    reviewerRole: "Developer"
  },
  {
    review: "As an educator, I appreciate the variety of educational materials available. It helps me enhance my teaching methods and provide more resources to my students.",
    reviewerName: "Michael Brown",
    reviewerRole: "Teacher"
  },
  {
    review: "The platform has become my go-to for expanding my knowledge. Highly recommend it to anyone interested in learning new things.",
    ...
    <div className="my-10">
      ...
      <div className="overflow-hidden relative w-full h-fit mx-auto rounded-3xl">
        <div
          ...
          {reviews.map((review)=>(
            <div key={review} className="min-w-full flex items-center justify-center">
                ...
                <div className="relative flex flex-col overflow-hidden rounded-lg bg-white px-8 w-[70%]">
                  ...
                  <div className="lg:py- flex flex-1 flex-col justify-between p-6 lg:px-7">
                    ...
                    <div className="mt-8 flex items-center tracking-wide">
                      ...
                      <p className="ml-3 text-gray-700">{review.reviewerRole}</p>
                    </div>
                  </div>
                </div>
              </div>
